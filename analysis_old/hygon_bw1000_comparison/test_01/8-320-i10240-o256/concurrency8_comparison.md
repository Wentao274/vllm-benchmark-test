...
| 成功请求数 | 320 | 320 |
| 失败请求数 | 0 | 0 |
| 测试持续时间 (s) | 521.20 | 2123.78 |
| 总输入 tokens | 3276800 | 3276800 |
| 总生成 tokens | 81920 | 81920 |
| **请求吞吐量 (req/s)** | **0.61** ⭐ | 0.15 |
| **输出 token 吞吐量 (tok/s)** | **157.18** ⭐ | 38.57 |
| 峰值输出 token 吞吐量 (tok/s) | **424.00** ⭐ | 160.00 |
| 峰值并发请求数 | 16.00 | 16.00 |
| **总 token 吞吐量 (tok/s)** | **6444.25** ⭐ | 1581.48 |
...
| 指标 | MiniMax-M2.5-W8A8 | MiniMax-M2.5-bf16 |
|------|----------- | -----------|
| 平均 TTFT (ms) | **7190.37** ⭐ | 34975.19 |
| 中位 TTFT (ms) | **8083.99** ⭐ | 39435.78 |
| P95 TTFT (ms) | **8094.81** ⭐ | 39548.64 |
| P99 TTFT (ms) | **8133.44** ⭐ | 39566.34 |
...
| 指标 | MiniMax-M2.5-W8A8 | MiniMax-M2.5-bf16 |
|------|----------- | -----------|
| 平均 TPOT (ms) | **22.89** ⭐ | 71.05 |
| 中位 TPOT (ms) | **19.52** ⭐ | 53.98 |
| P95 TPOT (ms) | **46.86** ⭐ | 188.73 |
| P99 TPOT (ms) | **46.97** ⭐ | 189.79 |
...
| 指标 | MiniMax-M2.5-W8A8 | MiniMax-M2.5-bf16 |
|------|----------- | -----------|
| 平均 ITL (ms) | **22.82** ⭐ | 70.79 |
| 中位 ITL (ms) | **19.56** ⭐ | 53.97 |
| P95 ITL (ms) | **20.53** ⭐ | 58.48 |
| P99 ITL (ms) | **24.15** ⭐ | 80.00 |
...
- **总token吞吐量**: MiniMax-M2.5-W8A8 最高，达 6444 tok/s
- **TTFT P99**: MiniMax-M2.5-W8A8 最优，为 8133.44ms
- **TPOT P99**: MiniMax-M2.5-W8A8 最优，为 46.97ms
