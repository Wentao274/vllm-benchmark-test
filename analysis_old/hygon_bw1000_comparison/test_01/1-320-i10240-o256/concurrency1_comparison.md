...
| 成功请求数 | 320 | 320 |
| 失败请求数 | 0 | 0 |
| 测试持续时间 (s) | 1509.26 | 3322.61 |
| 总输入 tokens | 3276800 | 3276800 |
| 总生成 tokens | 81920 | 81920 |
| **请求吞吐量 (req/s)** | **0.21** ⭐ | 0.10 |
| **输出 token 吞吐量 (tok/s)** | **54.28** ⭐ | 24.66 |
| 峰值输出 token 吞吐量 (tok/s) | **72.00** ⭐ | 50.00 |
| 峰值并发请求数 | 2.00 | 2.00 |
| **总 token 吞吐量 (tok/s)** | **2225.40** ⭐ | 1010.87 |
...
| 指标 | MiniMax-M2.5-W8A8 | MiniMax-M2.5-bf16 |
|------|----------- | -----------|
| 平均 TTFT (ms) | **1112.21** ⭐ | 5026.61 |
| 中位 TTFT (ms) | **1111.97** ⭐ | 5041.22 |
| P95 TTFT (ms) | **1127.95** ⭐ | 5072.83 |
| P99 TTFT (ms) | **1168.49** ⭐ | 5130.17 |
...
| 指标 | MiniMax-M2.5-W8A8 | MiniMax-M2.5-bf16 |
|------|----------- | -----------|
| 平均 TPOT (ms) | **14.13** ⭐ | 21.00 |
| 中位 TPOT (ms) | **14.13** ⭐ | 21.01 |
| P95 TPOT (ms) | **14.15** ⭐ | 21.05 |
| P99 TPOT (ms) | **14.16** ⭐ | 21.07 |
...
| 指标 | MiniMax-M2.5-W8A8 | MiniMax-M2.5-bf16 |
|------|----------- | -----------|
| 平均 ITL (ms) | **14.14** ⭐ | 20.97 |
| 中位 ITL (ms) | **14.13** ⭐ | 21.00 |
| P95 ITL (ms) | **14.47** ⭐ | 21.70 |
| P99 ITL (ms) | **20.17** ⭐ | 32.03 |
