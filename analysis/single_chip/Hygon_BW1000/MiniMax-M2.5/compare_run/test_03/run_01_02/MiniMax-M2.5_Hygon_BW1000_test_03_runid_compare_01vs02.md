# MiniMax-M2.5模型在单节点Hygon_BW1000上超长上下文测试对比报告
...
## 测试场景
对比同一芯片、同一测试套件下,同一模型优化前后超长上下文场景测试结果比对，分析性能差异。
...
**TTFT P99**: RUN-02 相比 RUN-01 平均改善 **56.4%** (延迟降低) <br>
**TPOT P99**: RUN-02 相比 RUN-01 平均改善 **12.4%** (延迟降低) <br>
