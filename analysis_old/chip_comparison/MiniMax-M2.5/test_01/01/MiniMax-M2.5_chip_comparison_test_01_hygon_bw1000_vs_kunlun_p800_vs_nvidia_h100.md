...
| 成功请求数                    | 320          | 320           |
| 失败请求数                    | 0            | 0             |
| 测试持续时间 (s)               | 1509.26      | 857.88        |
| 总输入 tokens               | 3276800      | 3276800       |
| 总生成 tokens               | 81920        | 81920         |
| **请求吞吐量 (req/s)**        | 0.21         | **0.37** ⭐    |
| **输出 token 吞吐量 (tok/s)** | 54.28        | **95.49** ⭐   |
| 峰值输出 token 吞吐量 (tok/s)   | 72.00        | **110.00** ⭐  |
| 峰值并发请求数                  | 2.00         | 2.00          |
| **总 token 吞吐量 (tok/s)**  | 2225.40      | **3915.14** ⭐ |

#### 首Token延迟 (TTFT)

| 指标 | Hygon_BW1000 | NVIDIA_H100 |
|------|----------- | -----------|
| 平均 TTFT (ms) | 1112.21 | **321.42** ⭐ |
| 中位 TTFT (ms) | 1111.97 | **306.62** ⭐ |
| P95 TTFT (ms) | 1127.95 | **313.59** ⭐ |
| P99 TTFT (ms) | 1168.49 | 1181.54 |
